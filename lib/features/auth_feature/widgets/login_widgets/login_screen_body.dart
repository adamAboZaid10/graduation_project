...
class LoginScreenBody extends StatelessWidget {
  ...
  const LoginScreenBody({Key? key, required this.formKey})
      : super(key: key); // Modify constructor

  @override
  Widget build(BuildContext context) {
    Get.put(LoginControllerImp(formKey)); // Pass the formKey to the controller
    return Scaffold(
      appBar: AppBar(
      ...
      body: GetBuilder<LoginControllerImp>(
        builder: (controller) => HandlingDataView(
          ...
          widget: Container(
            child: Form(
              key: formKey, // Use the provided formKey here
              child: ListView(
                children: [
                  Container(
                    ...
                    height: 230,
                    padding:
                        EdgeInsets.only(top: 23.h, left: 35.h, right: 35.h),
